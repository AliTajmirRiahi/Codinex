...
namespace Codinex.VisualStudio.References.Providers
{
    ...
    public sealed class InterfaceReferenceProvider(IVisualStudioServices visualStudio, IUiThreadDispatcher uiThreadDispatcher)
        : RoslynReferenceProviderBase(visualStudio, uiThreadDispatcher)
    {
            ...
            InterfaceDeclarationSyntax interfaceDeclaration)
        {
            ...
            {
                Id = ReferenceIdBuilder.BuildSymbolId(ReferenceKind.Interface, filePath, containerName, signature),
                Name = interfaceName,
