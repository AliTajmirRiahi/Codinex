...
namespace Codify.Core.Chat
{
    ...
    {
        private readonly IReferenceContextFormatter _referenceContextFormatter;

        public ChatMessageBuilder(IReferenceContextFormatter referenceContextFormatter)
        {
            _referenceContextFormatter = referenceContextFormatter ?? throw new ArgumentNullException(nameof(referenceContextFormatter));
        }
