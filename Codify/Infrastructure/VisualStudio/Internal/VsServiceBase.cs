...
namespace Codify.Infrastructure.VisualStudio.Internal
{
    ...
    public abstract class VsServiceBase
    {
        ...
        /// </summary>
        protected IVisualStudioServices VisualStudio { get; }

        protected VsServiceBase(IVisualStudioServices visualStudio)
        {
            VisualStudio = visualStudio ?? throw new ArgumentNullException(nameof(visualStudio));
        }
