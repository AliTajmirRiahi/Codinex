...
{
    public sealed class ClassReferenceProvider : RoslynReferenceProviderBase
    {
        public ClassReferenceProvider(IVisualStudioServices visualStudio) : base(visualStudio)
        {
