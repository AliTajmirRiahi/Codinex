...
{
    public sealed class FieldReferenceProvider : IReferenceProvider
    {
        private readonly IServiceProvider _serviceProvider;

        public FieldReferenceProvider(IServiceProvider serviceProvider)
        {
        ...
        public async Task<IReadOnlyList<ReferenceItem>> GetReferencesAsync()
        {
            ...
            foreach (var project in currentSolution.Projects)
            {
                foreach (var document in project.Documents)
                {
                    ...
                    var fieldItems = await ExtractFieldsAndPropertiesFromDocumentAsync(project, document).ConfigureAwait(false);
                    result.AddRange(fieldItems);
                }
            }
