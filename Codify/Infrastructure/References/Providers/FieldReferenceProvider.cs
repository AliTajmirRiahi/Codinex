...
{
    public sealed class FieldReferenceProvider : RoslynReferenceProviderBase
    {
        public FieldReferenceProvider(IVisualStudioServices visualStudio) : base(visualStudio) { }
